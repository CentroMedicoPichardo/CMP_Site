// src/app/(admin)/saber-pediatrico/documentos/page.tsx
"use client";
...
const API_URL = '/api/saber-pediatrico?tipo=documento&admin=true';
...
export default function DocumentosPage() {
  ...
  const handleSave = async (formData: any) => {
    ...
    try {
      ...
      const res = await fetch(url, {
        ...
        body: JSON.stringify({ ...formData, tipo: 'documento' })
      });
  ...
  return (
    <>
      <ContenidoHeader
        title="Documentos"
        description="Documentos descargables (PDF, guías, etc.)"
        totalItems={filteredItems.length}
        onCreateClick={handleCreate}
        buttonText="Nuevo Documento"
      />
