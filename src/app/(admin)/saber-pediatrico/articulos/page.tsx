// src/app/(admin)/saber-pediatrico/articulos/page.tsx
"use client";
...
const API_URL = '/api/saber-pediatrico?tipo=articulo&admin=true';
...
export default function ArticulosPage() {
  ...
  const handleSave = async (formData: any) => {
    ...
    try {
      ...
      const res = await fetch(url, {
        ...
        body: JSON.stringify({ ...formData, tipo: 'articulo' })
      });
  ...
  return (
    <>
      <ContenidoHeader
        title="Artículos"
        description="Artículos educativos sobre pediatría"
