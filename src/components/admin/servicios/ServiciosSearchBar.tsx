// src/components/admin/servicios/ServiciosSearchBar.tsx
'use client';
...
export function ServiciosSearchBar({ 
  ...
  const handleRefresh = async () => {
    setRefreshing(true);
    try {
      await mutate('/api/servicios?admin=true', undefined, { revalidate: true });
    ...
    <div className="mb-8 space-y-4">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <button
          ...
          `}
          title="Refrescar lista de servicios"
        >
          <RefreshCw 
            size={22} 
            className={`
