...
export function ServiciosSearchBar({
  searchTerm,
  onSearchChange,
  filterActivo,
  onFilterChange,
  onRefresh,
}: ServiciosSearchBarProps) {
      ...
      <div className="p-4 sm:p-5">
        <div className="mb-4">
          ...
          <p className="mt-1 text-xs leading-5 text-gray-500">
            Localiza servicios por título, descripción o ubicación.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-[minmax(0,1fr)_240px_auto] lg:items-end">
          ...
          <div>
            <label
              htmlFor="filtro-estado-servicios"
              className="mb-2 block text-xs font-extrabold text-[#0A3D62]"
            >
              Estado
            </label>
