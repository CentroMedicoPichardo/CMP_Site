// src/components/public/medico/MedicoSearchBar.tsx
'use client';

import { Search } from 'lucide-react';
import React from 'react';

interface MedicoSearchBarProps {
  busqueda: string;
  setBusqueda: (value: string) => void;
}

export function MedicoSearchBar({ busqueda, setBusqueda }: MedicoSearchBarProps) {
  return (
