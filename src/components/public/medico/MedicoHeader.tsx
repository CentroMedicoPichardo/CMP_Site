...
const caracteristicas = [
  {
    texto: "Especialistas capacitados",
    icono: Stethoscope,
  },
  {
    texto: "Atención profesional",
    icono: ShieldCheck,
  },
  {
    texto: "Trato humano y cercano",
    ...
    <section className="relative isolate overflow-hidden bg-[#082F4D] text-white">
      ...
      <div className="absolute inset-0 -z-30">
        <Image
          ...
          alt="Equipo médico del Centro Médico Pichardo"
          fill
          priority
          sizes="100vw"
      ...
      {/* Decoración */}
      <div
        className="pointer-events-none absolute -left-16 top-5 -z-10 h-36 w-36 rounded-full bg-[#FFC300]/10 blur-3xl"
        aria-hidden="true"
      />
        ...
        <div className="relative py-7 sm:py-8 lg:py-9">
          <div className="mx-auto max-w-5xl text-center">
            ...
            <h1 className="mt-3 text-2xl font-extrabold leading-tight tracking-tight text-white sm:text-3xl lg:text-4xl">
              Encuentra al especialista ideal para{" "}
            ...
            <p className="mx-auto mt-2.5 max-w-2xl text-sm leading-6 text-white/80 sm:text-base">
              Conoce a nuestros especialistas y encuentra atención
              profesional, cercana y comprometida con el cuidado de tus
              pequeños.
            </p>
                ...
                <div className="mb-1.5 flex items-center gap-2 px-2 text-left">
                  ...
                  <div>
                    ...
                    <p className="hidden text-[11px] text-gray-500 sm:block">
                      Ingresa el nombre o especialidad.
                    </p>
                  </div>
                </div>
