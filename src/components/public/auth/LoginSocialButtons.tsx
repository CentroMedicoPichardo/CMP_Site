...
export function LoginSocialButtons() {
  return (
    <div
      ...
      aria-label="Opciones de inicio de sesión social"
    >
      <BotonSocial
        proveedor="Google"
      ...
      <BotonSocial
        proveedor="Facebook"
        ariaLabel="Continuar con Facebook"
        icono={
          <FaFacebookF
            size={17}
            aria-hidden="true"
  ...
  return (
    ...
    >
      ...
      <span
        className={
          iconoClase
            ? `flex h-8 w-8 shrink-0 items-center justify-center rounded-lg ${iconoClase}`
